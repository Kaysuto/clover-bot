...
- **Intent MessageContent volontairement absent** : l'XP par message n'en a pas besoin (`messageCreate` s'émet sans lui). Ne pas l'ajouter sans raison forte.
...
├─ modules/<feature>/  logique métier (leveling, giveaways, invites, sync,
